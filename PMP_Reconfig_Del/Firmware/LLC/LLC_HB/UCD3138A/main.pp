...
typedef void (*FUNC_PTR)(); 	//used for zeroing instruction word.
 ...
 volatile Uint32 zoiw_address; //address to zero out integrity double word
 volatile Uint32 zoiw_flash_key; //flash key to zero out integrity double word - tells it which one to zero out.
...
//Optimize pmbus function
 Uint32 pmbus_watchdog_timer;
 Uint8  pmbus_pec_valid;
 Uint8 pmbus_pec_buffer[10]; //holds bytes recieved at beginning of read message used for pec calculation
 Uint8 pmbus_pec_buffer_number_of_bytes; //number of bytes in pec buffer used for pec calculation
/////////////////////////////////////////////////////////
//non-paged variables
